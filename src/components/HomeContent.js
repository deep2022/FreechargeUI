    ...
    return(
        <View style={{marginBottom:35}}>
            ...
            <View style={{marginHorizontal:10,marginVertical:10}}>
                ...
                <View style={{borderRadius:10,backgroundColor:'white',padding:25,marginVertical:10,flexDirection:'row',justifyContent:'space-between'}}>
                    <View style={{flexDirection:'column',alignItems:'center'}}>
                    <Entypo name={'book'} style={{backgroundColor:'#ffece6',borderRadius:8,padding:3}} color={'black'} size={30}/>
                    <Text style={{fontSize:16,color:'black',marginTop:5}}>Khata</Text>
                    </View>
                    <View style={{flexDirection:'column',alignItems:'center'}}>
                    <FontAwesome name={'rupee'} style={{backgroundColor:'#ffece6',borderRadius:8,padding:3,paddingHorizontal:10}} color={'black'} size={30}/>
                    <Text style={{fontSize:16,color:'black',marginTop:5}}>Paisa Plus</Text>
                    </View>
                    <View style={{flexDirection:'column',alignItems:'center'}}>
                    <Entypo name={'bar-graph'} style={{backgroundColor:'#ffece6',borderRadius:8,padding:3}} color={'black'} size={30}/>
                    <Text style={{fontSize:16,color:'black',marginTop:5}}>Website</Text>
                    </View>
                    <View style={{flexDirection:'column',alignItems:'center'}}>
                    <Entypo name={'stopwatch'} style={{backgroundColor:'#ffece6',borderRadius:8,padding:3}} color={'black'} size={30}/>
                    <Text style={{fontSize:16,color:'black',marginTop:5}}>Offers</Text>
                    </View>
                </View>
            </View>
